...
block_icmp(){
    ...
    output "Bu sistemi kullanmıyorsanız [1]'i, kullanıyorsanız [2]'yi seçmelisiniz.."
    output "[1] Evet."
    output "[2] Hayır."
    read icmp
    case $icmp in
...
block_bruteforce(){
    ...
    output "SSH Bruteforce'u engellemek için SADECE Fail2ban veya başka bir yöntem kullanmıyorsanız [1]'i seçmelisiniz. Kullanıyorsanız [2]'yi seçin."
    output "[1] Evet."
    output "[2] Hayır."
    read bruteforce
    case $bruteforce in
...
output "test"
output "© 2021 test <adalyan@gmail.com>."
...
block_bruteforce
javapipe_kernel
output "Sunucunuzu yeniden başlatıp oyun sunucunuzu aktif edebilirsiniz."
